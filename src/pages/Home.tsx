  ...
  return (
    <>
      <PageTitle
        ...
        description="Pico Soft Solutions builds high-quality, creative and agile business products — web applications, mobile apps and web services engineered to deliver measurable value to your customers."
      />
        ...
        <div className="mx-auto max-w-page px-6 py-20 lg:px-10 lg:py-28">
          <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-2">
            ...
            <div>
              ...
              <Reveal delay={0.36}>
                <Link to="/company" className="btn-secondary mt-8">
                  About our company
                </Link>
              </Reveal>
            </div>
